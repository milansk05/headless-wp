...
// Update the GET_COMMENTS query to include votes and nested structure
...
// Add new mutation to upvote/downvote comments
export const VOTE_COMMENT = gql`
  mutation VoteComment($commentId: ID!, $type: String!) {
    voteComment(input: { commentId: $commentId, type: $type }) {
      success
      message
      commentId
      voteCount
